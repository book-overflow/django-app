...
urlpatterns = [
    ...
    path(
        "login/",
        auth_views.CustomLoginView.as_view(template_name="login.html"),
        name="login",
    ),
    path(
        "logout/",
        auth_views.CustomLogoutView.as_view(template_name="logout.html"),
        name="logout",
    ),
    ...
    path(
        "messages/start/", message_views.start_conversation, name="start_conversation"
    ),
    path(
        "messages/start/", message_views.start_conversation, name="start_conversation"
    ),
    path(
        ...
        message_views.view_conversation,
